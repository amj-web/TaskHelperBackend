...
class LoginAPIView(GenericAPIView):
    ...
    def post(self, request):
        ...
        # if user not found, return response with message 
        # 'Invalid credentials, try again' and status 401
        return Response(
...
class UserAPIView(GenericAPIView):
    ...
    def get(self, request):
        ...
        # Initialize the serializer with the users
        # and set many=True since there are multiple users
...
class UserSpecificAPIView(GenericAPIView):
    ...
    def get(self, request, id):
        ...
        if userExists(id):
            ...
            # if user not found, return response with message 
            # 'User with this id doesn't exists!' and status 200
            return Response(
